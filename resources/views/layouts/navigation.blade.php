    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden sm:flex sm:grow justify-left space-x-8 sm:-my-px sm:ms-10 ">
                ...
                <x-nav-link :href="route('booking')" :active="request()->routeIs('booking')" class="text-white nav-underline" style="color:#F8F8F8;">
                    {{ __('Booking') }}
                </x-nav-link>
                <x-nav-link :href="route('notifications.index')" :active="request()->routeIs('notifications.index')" class="text-white nav-underline relative" style="color:#F8F8F8;">
                    {{ __('Notifications') }}
                    <div id="notification-count" class="absolute -top-2 -right-2 w-5 h-5 bg-red-600 rounded-full text-white text-xs flex items-center justify-center" style="display: none;">0</div>
                </x-nav-link>
            </div>
